  ...
  return (
    <div className="relative animate-hex-pulse gpu" style={{ width: size, height: size }}>
      <svg viewBox="0 0 200 200" width={size} height={size}>
        ...
        <polygon
          points="50,8 150,8 196,100 150,192 50,192 4,100"
          fill="none"
          stroke="url(#hexg)"
          strokeWidth="3"
        />
        <polygon
          points="65,30 135,30 175,100 135,170 65,170 25,100"
          fill="none"
          stroke="oklch(0.88 0.18 215 / 0.5)"
          strokeWidth="1.5"
        />
        <polygon
          points="80,55 120,55 150,100 120,145 80,145 50,100"
          fill="oklch(0.88 0.18 215 / 0.12)"
          stroke="oklch(0.88 0.18 215)"
          strokeWidth="1"
        />
        <text
          x="100"
